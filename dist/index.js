    ...
    return function (constructor) {
        ...
        for (const property of properties) {
            if (property === "constructor")
                continue;
            const type = Reflect.getMetadata("design:type", constructor.prototype, property);
            switch (type) {
                case String:
                ...
                case Number:
                    ...
                    break;
                case Date:
                    Reflect.decorate([IsDate(), Type(() => Date)], constructor.prototype, property);
                    break;
                default:
                    Reflect.decorate([ValidateNested(), Type(() => type)], constructor.prototype, property);
                    break;
            }
        }
    };
}
export async function serialize(cls, data) {
